...
HBA_MEM* pci_init() {
	...
	virt_page_allocator->alloc_virt_pages_range(abar_info.addr + MMIO_BASE,abar_info.addr, (abar_info.size + 0xFFF) & ~0xFFFULL, VirtPageAllocator::P | VirtPageAllocator::RW | VirtPageAllocator::PCD);
